...
## <img src="{{ site.baseurl }}/assets/images/logo (MindMosaic).png" alt="MindMosaic Logo" style="width: 16px; height: 16px; vertical-align: middle; margin-bottom: 5px;" /> MindMosaic 
